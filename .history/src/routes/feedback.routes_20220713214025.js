...
router.post('/api/v4/feedback/postFeedback', auth.VerifyJWT, feedbackUpload.single('file'), async (req, res) => {
...
router.get('/api/v4/feedback/getFeedback', auth.VerifyJWT, feedbackUpload.single('file'), async (req, res) => {
 //db mapping
